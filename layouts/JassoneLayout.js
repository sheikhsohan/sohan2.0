...
const JassoneLayout = ({ darkLogo = true }) => {
  ...
  useEffect(() => {
    ...
    setAboutData({
      ...
      bio: "Hi! My name is Hadiuzzaman (Sohan). I am Web designer and Developer, and I'm very passionate and dedicated to my work. With 2 years experience as a professional graphic designer, I have acquired the skills and knowledge necessary to make your project a success.",
    });
  }, []);
